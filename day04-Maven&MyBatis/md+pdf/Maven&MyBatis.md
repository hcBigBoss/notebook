...
## 2，Mybatis  （数据访问层的框架  包装了JDBC所有实现功能的一个小项目）

### 2.1  Mybatis概述

#### 2.1.1  Mybatis（轻量级框架）概念    hibernate（重量性框架） 16年前很火（一统天下）
...
​	1.想办法获得SqlSessionFactory对象

	2. 通过工厂生成一个 SqlSession对象
